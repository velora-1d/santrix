        ...
        <tbody>
            @forelse($santriList as $index => $santri)
                ...
                <tr>
                    ...
                    <td><b>{{ $talaran->jumlah_1_2 ?? 0 }}</b></td>
                    <td>{{ $talaran->tamat_1_2 ?? 0 }}</td>
                    <td>{{ $talaran->alfa_1_2 ?? 0 }}</td>
                    <td>{{ $talaran->total_1_2 ?? '-' }}</td>
                    <td class="text-alfa">@if(($talaran->alfa_1_2 ?? 0) > 0) ALFA {{ $talaran->alfa_1_2 }} @endif</td>
                </tr>
            @empty
                <tr>
