    ...
    <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 24px; align-items: stretch;">
        ...
        <div style="background: white; border-radius: 20px; box-shadow: 0 10px 30px rgba(0,0,0,0.03); border: 1px solid #f1f5f9; overflow: hidden; display: flex; flex-direction: column;">
            ...
            <div style="padding: 24px; flex: 1; display: flex; flex-direction: column;">
                ...
                <form method="GET" action="{{ route('bendahara.laporan.export-syahriah') }}" target="_blank" style="margin-top: auto;">
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px; margin-bottom: 20px;">
                        <div>
                            <label style="display: block; font-size: 0.75rem; font-weight: 600; color: #64748b; margin-bottom: 6px;">Tahun</label>
                            <input type="number" name="tahun" style="width: 100%; padding: 10px; border-radius: 8px; border: 1px solid #e2e8f0; font-size: 0.875rem;" value="{{ date('Y') }}">
                        </div>
                        <div>
        ...
        <div style="background: white; border-radius: 20px; box-shadow: 0 10px 30px rgba(0,0,0,0.03); border: 1px solid #f1f5f9; overflow: hidden; display: flex; flex-direction: column;">
            ...
            <div style="padding: 24px; flex: 1; display: flex; flex-direction: column;">
                ...
                <form method="GET" action="{{ route('bendahara.laporan.export-pemasukan') }}" target="_blank" style="margin-top: auto;">
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px; margin-bottom: 20px;">
                        <div>
        ...
        <div style="background: white; border-radius: 20px; box-shadow: 0 10px 30px rgba(0,0,0,0.03); border: 1px solid #f1f5f9; overflow: hidden; display: flex; flex-direction: column;">
            ...
            <div style="padding: 24px; flex: 1; display: flex; flex-direction: column;">
                ...
                <form method="GET" action="{{ route('bendahara.laporan.export-pengeluaran') }}" target="_blank" style="margin-top: auto;">
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px; margin-bottom: 20px;">
                        <div>
                            <label style="display: block; font-size: 0.75rem; font-weight: 600; color: #64748b; margin-bottom: 6px;">Mulai</label>
                            <input type="date" name="tanggal_mulai" style="width: 100%; padding: 10px; border-radius: 8px; border: 1px solid #e2e8f0; font-size: 0.875rem;">
        ...
        <div style="background: white; border-radius: 20px; box-shadow: 0 10px 30px rgba(0,0,0,0.03); border: 1px solid #f1f5f9; overflow: hidden; display: flex; flex-direction: column;">
            ...
            <div style="padding: 24px; flex: 1; display: flex; flex-direction: column;">
                ...
                <form method="GET" action="{{ route('bendahara.laporan.export-kas') }}" target="_blank" style="margin-top: auto;">
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px; margin-bottom: 20px;">
                        <div>
                            <label style="display: block; font-size: 0.75rem; font-weight: 600; color: #64748b; margin-bottom: 6px;">Mulai</label>
                            <input type="date" name="tanggal_mulai" style="width: 100%; padding: 10px; border-radius: 8px; border: 1px solid #e2e8f0; font-size: 0.875rem;">
        ...
        <div style="background: white; border-radius: 20px; box-shadow: 0 10px 30px rgba(0,0,0,0.03); border: 1px solid #f1f5f9; overflow: hidden; display: flex; flex-direction: column;">
            ...
            <div style="padding: 24px; flex: 1; display: flex; flex-direction: column;">
                ...
                <form method="GET" action="{{ route('bendahara.laporan.export-gaji') }}" target="_blank" style="margin-top: auto;">
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px; margin-bottom: 20px;">
                        <div>
                            <label style="display: block; font-size: 0.75rem; font-weight: 600; color: #64748b; margin-bottom: 6px;">Tahun</label>
                            <input type="number" name="tahun" style="width: 100%; padding: 10px; border-radius: 8px; border: 1px solid #e2e8f0; font-size: 0.875rem;" value="{{ date('Y') }}">
        ...
        <div style="background: white; border-radius: 20px; box-shadow: 0 10px 30px rgba(0,0,0,0.03); border: 1px solid #f1f5f9; overflow: hidden; display: flex; flex-direction: column;">
            ...
            <div style="padding: 24px; flex: 1; display: flex; flex-direction: column;">
                ...
                <form method="GET" action="{{ route('bendahara.laporan.export-keuangan-lengkap') }}" target="_blank" style="margin-top: auto;">
