...
<div style="max-width: 1200px; margin: 0 auto;">
    ...
    <form action="{{ route('owner.packages.update', $package->id) }}" method="POST">
        @csrf
        @method('PUT')
                    ...
                    <div style="padding: 24px; display: grid; gap: 24px;">
                        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 24px;">
                            <div>
                                ...
                                <input type="text" name="name" id="name" value="{{ old('name', $package->name) }}" required style="width: 100%; padding: 10px 12px; border: 1px solid #e2e8f0; border-radius: 8px; outline: none; transition: border-color 0.2s;">
                            </div>
                            <div>
                                <label for="slug" style="display: block; margin-bottom: 8px; font-weight: 500; font-size: 0.875rem; color: #374151;">Slug (ID Unik)</label>
                                <input type="text" name="slug" id="slug" value="{{ old('slug', $package->slug) }}" required style="width: 100%; padding: 10px 12px; border: 1px solid #e2e8f0; border-radius: 8px; outline: none; background: #f8fafc;">
                            </div>
                        </div>
                        <div>
                            ...
                            <textarea name="description" id="description" rows="3" style="width: 100%; padding: 10px 12px; border: 1px solid #e2e8f0; border-radius: 8px; outline: none;">{{ old('description', $package->description) }}</textarea>
                        </div>
                    </div>
                </div>
                    ...
                    <div style="padding: 24px;">
                        @if(is_array($package->features))
                            ...
                            <div style="display: flex; align-items: center; justify-content: space-between; padding: 12px; border: 1px dashed #e2e8f0; border-radius: 8px; margin-bottom: 12px;">
                                <div style="flex: 1;">
                                    <input type="text" name="feature_names[]" value="{{ $feature['name'] }}" style="border: none; background: transparent; width: 100%; font-weight: 500; color: #334155; outline: none;" placeholder="Nama Fitur">
                                </div>
                                <label style="cursor: pointer; display: flex; align-items: center;">
                                    <input type="checkbox" name="feature_included[{{ $index }}]" value="1" {{ isset($feature['included']) && $feature['included'] ? 'checked' : '' }} style="width: 18px; height: 18px; accent-color: #4f46e5;">
                                </label>
                            </div>
                            @endforeach
                        @endif
                        ...
                        <div style="display: flex; align-items: center; justify-content: space-between; padding: 12px; border: 1px dashed #e2e8f0; border-radius: 8px; margin-bottom: 12px;">
                            <div style="flex: 1;">
                                <input type="text" name="feature_names[]" placeholder="Tambah fitur baru..." style="border: none; background: transparent; width: 100%; color: #334155; outline: none;">
                            </div>
                            <label style="cursor: pointer; display: flex; align-items: center;">
                                <input type="checkbox" name="feature_included[{{ $currentCount + $i }}]" value="1" style="width: 18px; height: 18px; accent-color: #4f46e5;">
                            </label>
                        </div>
                        @endfor
                    </div>
                    ...
                    <div style="padding: 24px; display: grid; gap: 24px;">
                        <div>
                            ...
                            <div style="position: relative;">
                                ...
                                <input type="number" name="price" id="price" value="{{ old('price', $package->price) }}" required style="width: 100%; padding: 12px 12px 12px 40px; border: 1px solid #e2e8f0; border-radius: 8px; font-weight: 700; font-size: 1.125rem; outline: none;">
                            </div>
                        </div>
                         ...
                         <div>
                            ...
                            <div style="position: relative;">
                                ...
                                <input type="number" name="discount_price" id="discount_price" value="{{ old('discount_price', $package->discount_price) }}" style="width: 100%; padding: 12px 12px 12px 40px; border: 1px solid #fecaca; background: #fef2f2; border-radius: 8px; font-weight: 500; font-size: 1rem; color: #ef4444; outline: none; text-decoration: line-through;">
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="number" name="duration_months" id="duration_months" value="{{ old('duration_months', $package->duration_months) }}" required min="1" style="width: 100%; padding: 10px 12px; border: 1px solid #e2e8f0; border-radius: 8px; outline: none;">
                        </div>
                    </div>
                </div>
                        ...
                        <div style="display: flex; align-items: center; justify-content: space-between;">
                            <div>
                             ...
                             <label style="cursor: pointer;">
                                <input type="checkbox" name="is_featured" value="1" {{ $package->is_featured ? 'checked' : '' }} style="width: 20px; height: 20px; accent-color: #4f46e5;">
                            </label>
                        </div>
                         <div>
