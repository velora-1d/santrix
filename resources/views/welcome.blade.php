    ...
    <nav class="fixed top-0 left-0 right-0 z-50 glass transition-all duration-300">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-20">
                ...
                <div class="hidden md:flex items-center gap-4">
                    ...
                    <a href="{{ route('register.tenant', ['package' => 'advance-3']) }}" class="px-6 py-2.5 bg-gradient-to-r from-cyan-500 to-blue-500 text-white text-sm font-semibold rounded-lg shadow-lg shadow-cyan-500/25 hover:shadow-cyan-500/40 transition-all transform hover:-translate-y-0.5">
                        Daftar Pesantren
                    </a>
                </div>
        ...
        <div x-show="mobileMenu" x-cloak x-transition class="md:hidden glass border-t border-white/10">
            <div class="px-4 py-6 space-y-3">
                ...
                <a href="{{ route('register.tenant', ['package' => 'advance-3']) }}" class="block px-4 py-3 bg-gradient-to-r from-cyan-500 to-blue-500 text-white text-center font-semibold rounded-lg">
                    Daftar Pesantren
                </a>
            </div>
        </div>
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
            <div class="text-center max-w-4xl mx-auto">
                ...
                <div class="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16" data-aos="fade-up" data-aos-delay="300">
                    <a href="{{ route('register.tenant', ['package' => 'advance-3']) }}" class="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 py-4 bg-gradient-to-r from-cyan-500 to-blue-500 text-white font-bold rounded-xl shadow-xl shadow-cyan-500/25 hover:shadow-cyan-500/40 transition-all transform hover:-translate-y-1">
                        Daftar Pesantren
