        ...
        <div style="background: white; border-radius: 20px; box-shadow: 0 10px 30px rgba(0,0,0,0.03); border: 1px solid #f1f5f9; overflow: hidden;">
            ...
            <div style="padding: 24px;">
                <form method="POST" action="{{ route('bendahara.syahriah.store') }}">
                    ...
                    <!-- Advanced Filters for Selection -->
                    <div style="background: #f8fafc; border-radius: 16px; padding: 24px; margin-bottom: 32px; border: 1px solid #e2e8f0; position: relative;">
                        <div style="display: flex; align-items: center; gap: 10px; margin-bottom: 20px; color: #334155; font-weight: 800; font-size: 0.9rem; text-transform: uppercase; letter-spacing: 0.05em;">
                            <div style="width: 28px; height: 28px; background: #e2e8f0; border-radius: 6px; display: flex; align-items: center; justify-content: center;">
                                <i data-feather="search" style="width: 14px; height: 14px; color: #475569;"></i>
                            </div>
                            Cari Santri Cepat
                        </div>
                        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 16px;">
                            <div>
                                <label style="display: block; font-size: 0.75rem; font-weight: 700; color: #64748b; margin-bottom: 6px; text-transform: uppercase;">Gender</label>
                                <select id="filter-gender" style="width: 100%; padding: 10px; border-radius: 8px; border: 1px solid #e2e8f0; font-size: 0.875rem;">
                            ...
                            <div>
                                <label style="display: block; font-size: 0.75rem; font-weight: 700; color: #64748b; margin-bottom: 6px; text-transform: uppercase;">Asrama</label>
                                <select id="filter-asrama" style="width: 100%; padding: 10px; border-radius: 8px; border: 1px solid #e2e8f0; font-size: 0.875rem;">
                            ...
                            <div>
                                <label style="display: block; font-size: 0.75rem; font-weight: 700; color: #64748b; margin-bottom: 6px; text-transform: uppercase;">Kobong</label>
                                <select id="filter-kobong" style="width: 100%; padding: 10px; border-radius: 8px; border: 1px solid #e2e8f0; font-size: 0.875rem;">
                    ...
                    <div style="display: grid; grid-template-columns: 2fr 1fr 1fr; gap: 20px; margin-bottom: 20px;">
                        <div>
                            <label style="display: block; font-size: 0.875rem; font-weight: 600; color: #334155; margin-bottom: 8px;">Pilih Santri <span style="color: #ef4444;">*</span></label>
                            <select name="santri_id" id="santri-select" style="width: 100%; padding: 12px; border-radius: 10px; border: 1px solid #e2e8f0; font-size: 1rem;" required>
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 20px; margin-bottom: 32px;">
                        <div>
                            <label style="display: block; font-size: 0.875rem; font-weight: 600; color: #334155; margin-bottom: 8px;">Nominal <span style="color: #ef4444;">*</span></label>
                            <div style="position: relative;">
                                <span style="position: absolute; left: 12px; top: 12px; color: #64748b; font-weight: 600;">Rp</span>
                                <input type="text" name="nominal" class="format-rupiah" style="width: 100%; padding: 12px 12px 12px 40px; border-radius: 10px; border: 1px solid #e2e8f0; font-size: 1rem;" placeholder="0" required>
                            </div>
                        </div>
                        <div>
                            <label style="display: block; font-size: 0.875rem; font-weight: 600; color: #334155; margin-bottom: 8px;">Status</label>
                            <select name="is_lunas" style="width: 100%; padding: 12px; border-radius: 10px; border: 1px solid #e2e8f0; font-size: 1rem;" required>
                    ...
                    <div style="display: flex; justify-content: flex-end; pt-8;">
...
function filterKobong() {
    const filterAsrama = document.getElementById('filter-asrama').value;
    const filterKobong = document.getElementById('filter-kobong');
    const kobongOptions = filterKobong.querySelectorAll('option');
    ...
    kobongOptions.forEach((option, index) => {
        ...
        if (!filterAsrama || kobongAsrama === filterAsrama) {
            option.style.display = '';
        } else {
            option.style.display = 'none';
        }
    ...
    if (filterKobong.selectedIndex > 0 && 
        kobongOptions[filterKobong.selectedIndex].style.display === 'none') {
        filterKobong.selectedIndex = 0;
    }
}

// Event listeners
document.addEventListener('turbo:load', function() {
    document.getElementById('filter-gender').addEventListener('change', filterSantri);
    document.getElementById('filter-asrama').addEventListener('change', function() {
        filterKobong();
        filterSantri();
    });
    document.getElementById('filter-kobong').addEventListener('change', filterSantri);
});
